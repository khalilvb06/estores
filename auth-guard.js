...
// بدء الحماية فوراً عند تحميل السكريبت
console.log('بدء حماية الصفحات فوراً...');
protectAdminPages();

// تشغيل الحماية فوراً عند تحميل الصفحة
console.log('بدء حماية الصفحات...');
protectAdminPages();

// أيضاً تشغيل الحماية عند DOMContentLoaded كاحتياطي
document.addEventListener('DOMContentLoaded', () => {
  console.log('DOM محمل، التحقق من المصادقة مرة أخرى...');
  protectAdminPages();
});

// تشغيل الحماية أيضاً عند load للصفحة
window.addEventListener('load', () => {
  console.log('الصفحة محملة بالكامل، التحقق النهائي من المصادقة...');
  protectAdminPages();
});
